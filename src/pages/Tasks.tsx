...
export const Tasks = () => {
  ...
  const [newTask, setNewTask] = useState<CreateTaskRequest>({ title: '', taskDescription: '' });
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        <h1>Tasks</h1>
        <div>
          <button onClick={() => setShowCreateForm(!showCreateForm)} style={{ marginRight: '10px', padding: '10px 20px' }}>
